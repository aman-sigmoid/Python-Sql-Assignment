...
class Employee:
    ...
    def list_of_employees(self):
        ...
        print(df)
        final_data = pd.ExcelWriter('files/ques1.xlsx')
    ...
    def total_compensation(self):
        ...
        print("\n\n", df.head())
        writer = pd.ExcelWriter('files/ques2.xlsx')
    ...
    def file_to_table(self):
        with pd.ExcelFile('files/ques2.xlsx') as xls1:
    ...
    def compensation_at_dept_level(self):
        with pd.ExcelFile('files/ques2.xlsx') as xls2:
        ...
        final_data = pd.ExcelWriter('files/ques4.xlsx')
